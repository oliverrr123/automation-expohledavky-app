        ...
        headers: [
          ...
          },
          {
            ...
            value: process.env.NODE_ENV === 'production'
              ...
              ? "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://player.vimeo.com https://www.google.com/recaptcha/ https://www.gstatic.com/recaptcha/ https://www.google.com/recaptcha/enterprise.js https://www.gstatic.com/recaptcha/releases/; connect-src 'self' https://vitals.vercel-insights.com https://recaptchaenterprise.googleapis.com; img-src 'self' data: https://images.unsplash.com https://i.ibb.co https://*.placeholder.com https://www.google.com; style-src 'self' 'unsafe-inline'; font-src 'self' data:; frame-src https://player.vimeo.com https://www.google.com/maps/ https://www.google.com/recaptcha/ https://www.youtube.com; object-src 'none'; base-uri 'self';"
              // More permissive CSP for development
              : "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://player.vimeo.com https://www.google.com/recaptcha/ https://www.gstatic.com/recaptcha/ https://www.google.com/recaptcha/enterprise.js https://www.gstatic.com/recaptcha/releases/; connect-src 'self' https://vitals.vercel-insights.com https://recaptchaenterprise.googleapis.com; img-src 'self' data: https: http:; style-src 'self' 'unsafe-inline'; font-src 'self' data:; frame-src https://player.vimeo.com https://www.google.com/maps/ https://www.google.com/recaptcha/ https://www.youtube.com; object-src 'none';"
          }
        ]
      }
    ];
