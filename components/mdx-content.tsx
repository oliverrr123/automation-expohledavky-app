...
import { getDefaultLocale } from '@/lib/client-locale';

interface MDXContentProps {
  source: any;
  locale?: string; // Přidáme možnost předat locale explicitně
}

export default function MDXContent({ source, locale }: MDXContentProps) {
  ...
  // Vlastní komponenty pro MDX s předáním locale do BlogImage
  const components = {
