...
export const ROUTES: RouteMap = {
  ...
  cs: {
    ...
    "lustrace/payment-success": "background-checks/payment-success",
    "kontakt": "contact",
    "blog": "blog",
  ...
  sk: {
    ...
    "lustracia/payment-success": "background-checks/payment-success",
    "kontakt": "contact",
    "blog": "blog",
  ...
  de: {
    ...
    "uberprufungen/payment-success": "background-checks/payment-success",
    "kontakt": "contact",
    "blog": "blog",
  ...
  en: {
    ...
    "background-checks/payment-success": "background-checks/payment-success",
    "contact": "contact",
    "blog": "blog",
